...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  bool _isUpdating = false; // New state to track update progress
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final userProvider = Provider.of<UserProvider>(context); // Access provider for userType
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        builder: (context, userProvider, child) {
          ...
          return userProvider.isLoading && !_isUpdating
              ? Center(
              child: CircularProgressIndicator(color: Color(0XFF5AA189)))
              : SafeArea(
